...
$("#multiplechoice").click(function(){
	var myscript = "Multiple Choice<br><input class=\'longbox\' name=\'type"+counter+"\' type=\'hidden\' value=\'1\'><table><tr><td>Question:</td><td><input class=\'longbox\' name=\'question"+counter+"\' type=\'text\'></td></tr><tr><td>Answer:</td><td><input class=\'longbox\' name=\'answer1_"+counter+"\' type=\'text\'></td></tr><tr><td>Answer:</td><td><input class=\'longbox\' name=\'answer2_"+counter+"\' type=\'text\'></td></tr><tr><td>Answer:</td><td><input class=\'longbox\' name=\'answer3_"+counter+"\' type=\'text\'></td></tr><tr><td>Answer:</td><td><input class=\'longbox\' name=\'answer4_"+counter+"\' type=\'text\'></td></tr><tr><td>Correct Answer:</td><td><select name=\'correct"+counter+"\'><option value=\'1\' selected=\'selected\'>1</option><option value=\'2\'>2</option><option value=\'3\'>3</option><option value=\'4\'>4</option></select></td></tr><tr><td>Point Value:</td><td><input name=\'pvalue"+counter+"\' type=\'number\'></td></tr><tr><td>Tags:</td><td><textarea name=\'tags"+counter+"\'></textarea></td></tr></table><hr></div><div id=\'qfields"+(counter+1)+"\'>";
	$("#qfields"+counter).html(myscript);
	counter++;
});
$("#truefalse").click(function(){
	var myscript = "True/False<br><input class=\'longbox\' name=\'type"+counter+"\' type=\'hidden\' value=\'2\'><table><tr><td>Question:</td><td><input class=\'longbox\' name=\'question"+counter+"\' type=\'text\'></td></tr><tr><td>Correct Answer:</td><td><select name=\'correct"+counter+"\'><option value=\'1\' selected=\'selected\'>True</option><option value=\'2\'>False</option></select></td></tr><tr><td>Point Value:</td><td><input name=\'pvalue"+counter+"\' type=\'number\'></td></tr><tr><td>Tags:</td><td><textarea name=\'tags"+counter+"\'></textarea></td></tr></table><hr></div><div id=\'qfields"+(counter+1)+"\'>";
	$("#qfields"+counter).html(myscript);
	counter++;
});
$("#shortanswer").click(function(){
	var myscript = "Short Answer<br><input class=\'longbox\' name=\'type"+counter+"\' type=\'hidden\' value=\'3\'><table><tr><td>Question:</td><td><input class=\'longbox\' name=\'question"+counter+"\' type=\'text\'></td></tr><tr><td>Correct Answer:</td><td><input name=\'correct"+counter+"\' type=\'text\'></td></tr><tr><td>Point Value:</td><td><input name=\'pvalue"+counter+"\' type=\'number\'></td></tr><tr><td>Tags:</td><td><textarea name=\'tags"+counter+"\'></textarea></td></tr></table><hr></div><div id=\'qfields"+(counter+1)+"\'>";
	$("#qfields"+counter).html(myscript);
	counter++;
});
$("#programming").click(function(){
	var myscript = "Test Cases should be an equivilance (i.e. if your question is \"create a function add2 to add and return 2 numbers together\", then your equivilence case should be \"add2(3,4) == 7\")<br>Test Code area should be used for creating functions that the students code can be tested against. This isn\'t required but allows for more intricate tests.<br><input class=\'longbox\' name=\'type"+counter+"\' type=\'hidden\' value=\'4\'><table><tr><td>Question:</td><td><input class=\'longbox\' name=\'question"+counter+"\' type=\'text\'></td></tr><tr><td>Test Case 1:</td><td><input class=\'longbox\' name=\'testcase1_"+counter+"\' type=\'text\'></td></tr><tr><td>Test Case 2:</td><td><input class=\'longbox\' name=\'testcase2_"+counter+"\' type=\'text\'></td></tr><tr><td>Test Case 3:</td><td><input class=\'longbox\' name=\'testcase3_"+counter+"\' type=\'text\'></td></tr><tr><td>Test Case 4:</td><td><input class=\'longbox\' name=\'testcase4_"+counter+"\' type=\'text\'></td></tr><tr><td>Test Code:</td><td><textarea name=\'testcode"+counter+"\'></textarea></td></tr><tr><td>Point Value:</td><td><input name=\'pvalue"+counter+"\' type=\'number\'></td></tr><tr><td>Tags:</td><td><textarea name=\'tags"+counter+"\'></textarea></td></tr></table><hr></div><div id=\'qfields"+(counter+1)+"\'>";
	$("#qfields"+counter).html(myscript);
	counter++;
});
